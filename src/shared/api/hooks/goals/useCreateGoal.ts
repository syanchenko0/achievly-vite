...
import { createGoalMutationResponseSchema, createGoalMutationRequestSchema } from '../../zod/goals/createGoalSchema.ts'
...
export async function createGoal(
  ...
  const res = await request<CreateGoalMutationResponse, ResponseErrorConfig<CreateGoal400>, CreateGoalMutationRequest>({
    method: 'POST',
    url: `/goals`,
    data: createGoalMutationRequestSchema.parse(data),
    ...requestConfig,
  })
